...
return [
    ...
    'brokersModel' => Megatravel\SSO\Models\Broker::class,
    'usersResource' => \App\Resources\Users\UserResource::class,
    ...
    // Model relations to set in the UMO (User Model Objetc)
    'models_to_get' => [
        // Return array with models for UserResource
        'roles',
        'deptos',
    ],
