						...
						<div class="card-body">
							<div class="row">
								<div class="col-xl-12">
									...
									<div class="row">
										<div class="col-sm-3">
											<img src="{{URL::asset('build/img/img-4.jpg')}}" alt="image" class="img-fluid rounded" width="200">
											<p class="mb-0">
												<code>.rounded</code>
											</p>
										</div>
										...
										<div class="col-sm-3">
											<img src="{{URL::asset('build/img/img-1.jpg')}}" alt="image" class="img-fluid img-thumbnail" width="200">
											<p class="mb-0">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body d-flex justify-content-between gap-2">
							<figure class="figure">
								<img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="{{URL::asset('build/img/img-1.jpg')}}" alt="...">
