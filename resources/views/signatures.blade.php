                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('signatures')}}" class="active">Signatures</a>
                                                    </li>
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <div class="page-btn">
                                <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#add-custom-field"><i class="ti ti-circle-plus me-1"></i>Add
                                    Signature</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <img src="{{URL::asset('build/img/invoice/signature.svg')}}"
                                                        class="signature-img" alt="Img">
                                                </div>
                                            </td>
                                            <td>
                                                <span
                                            ...
                                            <td class="action-table-data">
                                                <div class="edit-delete-action">
                                                    <a class="me-2 p-2" href="#">
                                                        <i data-feather="star" class="feather-edit"></i>
                                                    </a>
