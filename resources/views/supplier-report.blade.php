		...
		<div class="content">
			<div class="mb-4">
				<ul class="nav nav-pills">
					<li class="nav-item">
						<a class="nav-link active" href="{{url('supplier-report')}}">Supplier Report</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{url('supplier-due-report')}}">Supplier Due</a>
					</li>
				</ul>
			</div>
			<div>
					...
					<div class="card-body p-0">
						<div class="table-responsive">
							<table class="table datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md me-2">
													<img src="{{URL::asset('build/img/supplier/supplier-02.png')}}" alt="Img">
												</a>
								...
								<tfoot>
									<td class="bg-light text-dark fw-bold p-3 fs-16" colspan="4">Total</td>
									<td class="bg-light text-dark fw-bold p-3 fs-16" colspan="3">$33268.53</td>
								</tfoot>
							</table>
						</div>
					</div>
