										...
										<table class="table mb-0">
											...
											<tbody>
												<tr>
													<th scope="row">
														<span class="avatar avatar-sm">
															<img src="{{URL::asset('build/img/products/product49.jpg')}}" alt="img">
														</span>
													</th>
													<td>Wrist Watch</td>
													<td>Watch</td>
												...
												<tr>
													<th scope="row">
														<span class="avatar avatar-sm">
															<img src="{{URL::asset('build/img/products/product28.jpg')}}" alt="img">
														</span>
													</th>
													<td>Camera</td>
													<td>Gadgets</td>
												...
												<tr>
													<th scope="row">
														<span class="avatar avatar-sm">
															<img src="{{URL::asset('build/img/products/product60.jpg')}}" alt="img">
														</span>
													</th>
													<td>Shoes</td>
													<td>Footwear</td>
								...
								<div class="col-md-9">
									<div class="tab-content">
										<div class="tab-pane show active text-muted" id="home-vertical-custom"
											...
											<ul class="mb-0">
												<li class="mb-2">
													How travel coupons make you a better lover. Why cultural solutions are the new black. Why mom was right about travel insurances. How family trip ideas can helpyou predict the future. <b>How carnival cruises make you a better lover</b>. Why you'll never succeed at daily deals.
									...
									<div class="tab-content">
										<div class="tab-pane show active text-muted" id="employee-vertical"
											...
											<ul class="mb-0">
												...
												<li>How hotel deals can help you live a better life. <b>How celebrity cruises</b> aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it.
												</li>
											</ul>
										</div>
