					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="progress progress-vertical progress-xl">
								<div class="progress-bar bg-danger" role="progressbar" style="height: 90%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="progress progress-lg mb-5 custom-progress-3 progress-animate" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
								<div class="progress-bar bg-success" style="width: 70%">
