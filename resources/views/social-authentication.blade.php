                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('social-authentication')}}"
                                                            class="active">Social Authentication</a></li>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="border-bottom pb-3 mb-3">Connect with friends, family and share
                                                updates, photos, moments with people you know.</p>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#fb-connect"><i class="ti ti-tool me-1"></i>View
                                                        Integration</a>
                                                </div>
                                                <div
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="border-bottom pb-3 mb-3">Communicate and stay connected through
                                                the exchange of quick, frequent messages</p>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#twitter-connect"><i
                                                            class="ti ti-tool me-1"></i>View Integration</a>
                                                </div>
                                                <div
                                                    class="status-toggle modal-status d-flex justify-content-between align-items-center ms-2">
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="border-bottom pb-3 mb-3">Network with people and professional
                                                organizations in your industry.</p>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#linkedin-connect"><i
                                                            class="ti ti-tool me-1"></i>Connect Now</a>
                                                </div>
                                                <div
                                                    class="status-toggle modal-status d-flex justify-content-between align-items-center ms-2">
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="border-bottom pb-3 mb-3">Google has many special features to help
                                                you find exactly what you're looking for.</p>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#google-connect"><i
                                                            class="ti ti-tool me-1"></i>View Integration</a>
                                                </div>
                                                <div
                                                    class="status-toggle modal-status d-flex justify-content-between align-items-center ms-2">
