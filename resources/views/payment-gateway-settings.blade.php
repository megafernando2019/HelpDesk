                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">PayPal is the faster, safer way to send and receive
                                                    money </p>
                                            </div>
                                            <div
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-sm btn-outline-secondary"
                                                    data-bs-toggle="modal" data-bs-target="#payment-connect">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">APIs to accept cards, manage subscriptions, send money.
                                                </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Braintree offers more fraud protection and security
                                                    features.</p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Allows send international money transfers and payments
                                                    quickly </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Provide payment solution to individuals to make payments
                                                </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Replaces your physical cards and cash with private and
                                                    secure </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Fast, Low-Cost Solution for your International Business.
                                                </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Online payment platform that enables to send & receive
                                                    money </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Midtrans provides the maximum number of payment methods
                                                </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">PyTorch, a network through which your customers transfer
                                                    funds</p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Direct transfer of funds from one bank account into
                                                    another.</p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="card flex-fill">
                                        <div class="w-100 card-body">
                                            <div class="d-flex flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Indicating that goods must be paid for at the time of
                                                    delivery. </p>
                                            </div>
                                            <div
                                                class="d-flex align-items-center justify-content-between border-top pt-3">
