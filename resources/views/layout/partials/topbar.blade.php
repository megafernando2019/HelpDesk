@if (!Route::is(['pos-2', 'pos-3', 'pos-4', 'pos-5', 'pos']))
<!-- Header -->
<div class="header">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item nav-item-box">
                <a href="javascript:void(0);" class="nav-link" data-bs-toggle="dropdown">
                    <img class="profileset" src="{{Storage::url('icons/tugui_helpdesk.png')}}" alt="Notificaciones">
                    <span class="badge rounded-pill text-white">8</span>
                </a>
                <div class="dropdown-menu">
                    notificaciones helpdesk
                </div>
            </li>
...
<div class="header pos-header">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item pos-nav">
            <a href="{{route('index')}}" class="btn btn-purple btn-md d-inline-flex align-items-center">
        ...
        <li class="nav-item nav-item-box" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="POS Settings">
            <a href="{{route('pos-settings')}}"><i class="ti ti-settings"></i></a>
        </li>
        <li class="nav-item dropdown has-arrow main-drop profile-nav">
            <a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
                <span class="user-info p-0">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <a class="dropdown-item" href="{{route('profile')}}"><i class="me-2" data-feather="user"></i>My
                        Profile</a>
                    <a class="dropdown-item" href="{{route('general-settings')}}"><i class="me-2"
                            data-feather="settings"></i>Settings</a>
                    <hr class="m-0">
                    <a class="dropdown-item logout" href="{{route('signin')}}"><img
