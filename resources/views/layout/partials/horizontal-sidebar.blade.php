        ...
        <div id="sidebar-menu-3" class="sidebar-menu">
            <div class="main-menu">
                <ul class="nav-menu">
                    <li class="submenu">
                        <a href="{{route('index')}}"
                            class="{{ Request::is('index', '/', 'admin-dashboard', 'sales-dashboard', 'dashboard', 'companies', 'subscription', 'packages', 'domain', 'purchase-transaction', 'chat', 'audio-call', 'call-history', 'video-call', 'calendar', 'contacts', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'file-manager', 'projects', 'products', 'orders', 'customers', 'cart', 'checkout', 'wishlist', 'reviews', 'social-feed', 'search-list', 'layout-horizontal', 'layout-detached', 'layout-two-column', 'layout-hovered', 'layout-boxed', 'layout-rtl', 'layout-dark') ? 'active subdrop' : '' }}"><i
                                class="ti ti-layout-grid fs-16 me-2"></i><span> Main Menu</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('index', '/', 'admin-dashboard', 'sales-dashboard') ? 'active subdrop' : '' }}"><span>Dashboard</span>
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{route('admin-dashboard')}}"
                                            class="{{ Request::is('admin-dashboard') ? 'active' : '' }}">Admin Dashboard
                                            2</a></li>
                                    <li><a href="{{route('sales-dashboard')}}"
                                            class="{{ Request::is('sales-dashboard') ? 'active' : '' }}">Sales
                                            Dashboard</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('dashboard', 'companies', 'subscription','packages','domain','purchase-transaction') ? 'active subdrop' : '' }}"><span>Super
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('chat','audio-call','call-history','video-call','calendar','contacts','email','email-reply','todo','todo-list','notes','file-manager','projects','products','orders','customers','cart','checkout','wishlist','reviews','social-feed','search-list') ? 'active subdrop' : '' }}"><span>Application</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    ...
                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{route('audio-call')}}"
                                                    class="{{ Request::is('audio-call') ? 'active' : '' }}">Audio
                                                    Call</a></li>
                                    ...
                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{route('checkout')}}"
                                                    class="{{ Request::is('checkout') ? 'active' : '' }}">Checkout</a>
                                            </li>
                                            <li><a href="{{route('wishlist')}}"
                                                    class="{{ Request::is('wishlist') ? 'active' : '' }}">Wishlist</a>
                                            </li>
                                            <li><a href="{{route('reviews')}}"
                                                    class="{{ Request::is('reviews') ? 'active' : '' }}">Reviews</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="{{route('social-feed')}}"
                                            class="{{ Request::is('social-feed') ? 'active' : '' }}">Social Feed</a>
                                    </li>
                                    <li><a href="{{route('search-list')}}"
                                            class="{{ Request::is('search-list') ? 'active' : '' }}">Search List</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('layout-horizontal', 'layout-detached', 'layout-two-column', 'layout-hovered', 'layout-boxed', 'layout-rtl', 'layout-dark') ? 'active subdrop' : '' }}"><span>Layouts</span><span
                                        class="menu-arrow inside-submenu"></span></a>
                                <ul>
                                    <li><a href="{{route('layout-horizontal')}}"
                                            class="{{ Request::is('layout-horizontal') ? 'active' : '' }}">Horizontal</a>
                                    </li>
                                    <li><a href="{{route('layout-detached')}}"
                                            class="{{ Request::is('layout-detached') ? 'active' : '' }}">Detached</a>
                                    </li>
                                    <li><a href="{{route('layout-two-column')}}"
                                            class="{{ Request::is('layout-two-column') ? 'active' : '' }}">Two
                                            Column</a></li>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"
                            class="{{ Request::is('product-list','edit-product','product-details', 'add-product', 'expired-products', 'low-stocks', 'category-list', 'sub-categories', 'brand-list', 'varriant-attributes', 'units', 'warranty', 'barcode', 'qrcode') ? 'active subdrop' : '' }}"><i
                                class="ti ti-brand-unity fs-16 me-2"></i></i><span> Inventory
                            </span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="{{route('product-list')}}"
                                    class="{{ Request::is('product-list','product-details','edit-product') ? 'active' : '' }}">Products</a>
                            </li>
                            <li><a href="{{route('add-product')}}"
                                    class="{{ Request::is('add-product') ? 'active' : '' }}">Create Product</a></li>
                            <li><a href="{{route('expired-products')}}"
                                    class="{{ Request::is('expired-products') ? 'active' : '' }}">Expired Products</a>
                            </li>
                            <li><a href="{{route('low-stocks')}}"
                                    class="{{ Request::is('low-stocks') ? 'active' : '' }}">Low Stocks</a></li>
                            <li><a href="{{route('category-list')}}"
                                    class="{{ Request::is('category-list') ? 'active' : '' }}">Category</a></li>
                            <li><a href="{{route('sub-categories')}}"
                                    class="{{ Request::is('sub-categories') ? 'active' : '' }}">Sub Category</a></li>
                            <li><a href="{{route('brand-list')}}"
                                    class="{{ Request::is('brand-list') ? 'active' : '' }}">Brands</a></li>
                            <li><a href="{{route('units')}}"
                                    class="{{ Request::is('units') ? 'active' : '' }}">Units</a></li>
                            <li><a href="{{route('varriant-attributes')}}"
                                    class="{{ Request::is('varriant-attributes') ? 'active' : '' }}">Variant
                                    Attributes</a></li>
                            <li><a href="{{route('warranty')}}"
                                    class="{{ Request::is('warranty') ? 'active' : '' }}">Warranties</a></li>
                            <li><a href="{{route('barcode')}}"
                                    class="{{ Request::is('barcode') ? 'active' : '' }}">Print Barcode</a></li>
                            <li><a href="{{route('qrcode')}}" class="{{ Request::is('qrcode') ? 'active' : '' }}">Print
                                    QR Code</a></li>
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"
                            class="{{ Request::is('manage-stocks', 'stock-adjustment', 'stock-transfer','online-orders', 'pos-orders', 'invoice','invoice-details','invoice-details', 'sales-returns', 'quotation-list','pos', 'pos-2', 'pos-3', 'pos-4', 'pos-5','coupons', 'gift-cards','discount-plan', 'discount'
							,'purchase-list', 'purchase-order-report', 'purchase-returns','expense-list', 'expense-category','income', 'income-category','account-list','money-transfer','balance-sheet' ,'balance-sheet-v2','trial-balance','cash-flow' ,'cash-flow-v2','account-statement' ) ? 'active subdrop' : '' }}"><i
                                class="ti ti-layout-grid fs-16 me-2"></i><span>Sales &amp; Purchase</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('manage-stocks', 'stock-adjustment', 'stock-transfer') ? 'active subdrop' : '' }}"><span>Stock</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{route('manage-stocks')}}"
                                            class="{{ Request::is('manage-stocks') ? 'active' : '' }}">Manage Stock</a>
                                    </li>
                                    <li><a href="{{route('stock-adjustment')}}"
                                            class="{{ Request::is('stock-adjustment') ? 'active' : '' }}">Stock
                                            Adjustment</a></li>
                                    <li><a href="{{route('stock-transfer')}}"
                                            class="{{ Request::is('stock-transfer') ? 'active' : '' }}">Stock
                                            Transfer</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('online-orders', 'pos-orders', 'invoice','invoice-details', 'sales-returns', 'quotation-list','pos', 'pos-2', 'pos-3', 'pos-4', 'pos-5') ? 'active subdrop' : '' }}"><span>Sales</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"
                                        ...
                                        <ul>
                                            <li><a href="{{route('online-orders')}}"
                                                    class="{{ Request::is('online-orders') ? 'active' : '' }}">Online
                                                    Orders</a></li>
                                            <li><a href="{{route('pos-orders')}}"
                                                    class="{{ Request::is('pos-orders') ? 'active' : '' }}">POS
                                                    Orders</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="{{route('sales-returns')}}"
                                            class="{{ Request::is('sales-returns') ? 'active' : '' }}">Sales Return</a>
                                    </li>
                                    <li><a href="{{route('quotation-list')}}"
                                            class="{{ Request::is('quotation-list') ? 'active' : '' }}">Quotation</a>
                                    </li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"
                                        ...
                                        <ul>
                                            <li><a href="{{route('pos')}}"
                                                    class="{{ Request::is('pos') ? 'active' : '' }}">POS 1</a></li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('coupons', 'gift-cards','discount-plan', 'discount') ? 'active subdrop' : '' }}"><span>Promo</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{route('coupons')}}"
                                            class="{{ Request::is('coupons') ? 'active' : '' }}"><span>Coupons</span></a>
                                    </li>
                                    <li><a href="{{route('gift-cards')}}"
                                            class="{{ Request::is('gift-cards') ? 'active' : '' }}"><span>Gift
                                                Cards</span></a></li>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"
                                        ...
                                        <ul>
                                            <li><a href="{{route('discount-plan')}}"
                                                    class="{{ Request::is('discount-plan') ? 'active' : '' }}">Discount
                                                    Plan</a></li>
                                            <li><a href="{{route('discount')}}"
                                                    class="{{ Request::is('discount') ? 'active' : '' }}">Discount</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('purchase-list', 'purchase-order-report', 'purchase-returns') ? 'active subdrop' : '' }}"><span>Purchase</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);" class="{{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals'
								...
								,'tables-basic', 'data-tables','maps-vector', 'maps-leaflet') ? 'active subdrop' : '' }}"><i
                                class="ti ti-users-group fs-16 me-2"></i><span>UI Interface</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-borders', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-colors', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-lightbox', 'ui-media', 'ui-modals'
									, 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders', 'ui-rangeslider', 'ui-spinner', 'ui-sweetalerts', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-video', 'ui-sortable', 'ui-swiperjs') ? 'active subdrop' : '' }}"><span>Base
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag', 'icon-tabler', 'icon-bootstrap', 'icon-remix') ? 'active subdrop' : '' }}"><span>Icons</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('signin', 'signin-2', 'signin-3','register', 'register-2', 'register-3','forgot-password', 'forgot-password-2', 'forgot-password-3','reset-password', 'reset-password-2', 'reset-password-3' 
									,'email-verification', 'email-verification-2', 'email-verification-3','two-step-verification', 'two-step-verification-2', 'two-step-verification-3' ) ? 'active subdrop' : '' }}"><span>Authentication</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('pages','all-blog', 'blog-details', 'blog-tag', 'blog-categories', 'blog-comments','countries', 'states', 'cities', 'testimonials', 'faq') ? 'active subdrop' : '' }}"><span>Content</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li class="submenu">
                                        <a href="javascript:void(0);"
                                    ...
                                    <li class="submenu">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{route('blog-tag')}}"
                                                    class="{{ Request::is('blog-tag') ? 'active' : '' }}">Blog Tags</a>
                                            </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('employees-grid','add-employee','edit-employee','employee-details','employees-list', 'department-grid', 'designation', 'shift' ,'department-list') ? 'active subdrop' : '' }}"><span>Employees</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    ...
                                    <li><a href="{{route('shift')}}"
                                            class="{{ Request::is('shift') ? 'active' : '' }}"><span>Shifts</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu">
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"
                            class="{{ Request::is('sales-report', 'best-seller','inventory-report', 'stock-history', 'sold-stock','supplier-report', 'supplier-due-report','customer-report', 'customer-due-report','product-report', 'product-expiry-report', 'product-quantity-alert') ? 'active subdrop' : '' }}"><i
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"
                            class="{{ Request::is('general-settings', 'security-settings', 'notification','activities', 'connected-apps','system-settings', 'company-settings', 'localization-settings', 'prefixes', 'preference', 'appearance', 'social-authentication', 'language-settings' 
						,'invoice-settings','language-settings-web', 'invoice-templates', 'printer-settings', 'pos-settings', 'signatures', 'custom-fields','email-settings', 'email-templates','sms-settings', 'sms-templates', 'otp-settings' , 'gdpr-settings','payment-gateway-settings', 'bank-settings-grid','bank-settings-list', 'tax-rates', 'currency-settings','storage-settings', 'ban-ip-address') ? 'active subdrop' : '' }}"><i
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"
                            class="{{ Request::is('billers', 'suppliers', 'store-list', 'warehouse','users', 'roles-permissions','permissions', 'delete-account') ? 'active subdrop' : '' }}"><i
                                class="ti ti-circle-plus fs-16 me-2"></i><span>More</span><span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('billers', 'suppliers', 'store-list', 'warehouse') ? 'active subdrop' : '' }}"><span>People</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{route('customers')}}"><span>Customers</span></a></li>
                                    <li><a href="{{route('billers')}}"
                                            class="{{ Request::is('billers') ? 'active' : '' }}"><span>Billers</span></a>
                                    </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('users', 'roles-permissions','permissions', 'delete-account') ? 'active subdrop' : '' }}"><span>User
                                        Management</span><span class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{route('users')}}"
                                            class="{{ Request::is('users') ? 'active' : '' }}"><span>Users</span></a>
                                    </li>
                                    ...
                                    <li><a href="{{route('delete-account')}}"
                                            class="{{ Request::is('delete-account') ? 'active' : '' }}"><span>Delete
