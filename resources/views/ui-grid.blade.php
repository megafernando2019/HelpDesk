			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							...
							<p class="mt-1 f-m-light">You may use predefined grid classes. Using <code>.col-md-* </code>you can set the grid system.</p>
						</div>
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							...
							<p class="mt-1 f-m-light">You can use the <code>align-items-*</code> class to set the vertical alignment.
							</p>
						</div>
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							...
							<p class="mt-1 f-m-light">You can use the <code>justify-content-*</code> class to set the horizontal alignment.</p>
						</div>
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							...
							<p class="mt-1 f-m-light">To nest your content with the default grid, add a new<code>.row</code> and set
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							...
							<p class="mt-1 f-m-light">You can offset the grid column using <code>.offset-*</code> grid class.</p>
						</div>
						<div class="card-body grid-showcase">
							<div class="row g-2">
				...
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<p class="mb-4">With the move to flexbox in v4, you can use margin utilities like <span class="text-danger">.me-auto</span>to force sibling columns away from one another.
							</p>
							<div class="grid-showcase">
								<div class="row mb-3">
					...
					<div class="card ">
						...
						<div class="card-body">
							<p>The <span class="text-danger">.col-*</span> classes can also be used
								outside a
								<span class="text-danger">.row</span> to give an element a specific width. Whenever column classes are used as non direct children of a row,the paddings are omitted.</p>
							<div class="grid-showcase">
								<div class="col-3">
				...
				<div class="col-lg-6">
					<div class="card">
						<div class="card-body">
							<P>The classes can be used together with utilities to create responsive floated images. Make sure to wrap the content in a <span class="text-danger">.clearfix</span> wrapper to clear the float if the text is shorter.</P>
							<div class="clearfix">
								<img src="{{URL::asset('build/img/supplier/edit-supplier.jpg')}}" class="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="...">
								<p> A paragraph of placeholder text. We're using it here to show the use of the
									clearfix class. We're adding quite a few meaningless phrases here to demonstrate how the columns interact here with the floated image.
								</p>
