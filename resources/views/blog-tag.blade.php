        ...
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    ...
                    <div class="page-btn">
                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_blog_tag"><i class="ti ti-circle-plus me-1"></i>Add Tags</a>
                    </div>
                </ul>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="#" class="p-2 d-flex align-items-center border rounded me-2" data-bs-toggle="modal" data-bs-target="#edit_blog_tag"><i class="ti ti-edit"></i></a>
