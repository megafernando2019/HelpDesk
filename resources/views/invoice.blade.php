                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV001</a></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV002</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV003</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV004</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV005</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV006</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV007</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV008</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV009</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV010</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('invoice-details')}}">INV011</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                                <img src="{{URL::asset('build/img/users/user-05.jpg')}}" alt="product">
