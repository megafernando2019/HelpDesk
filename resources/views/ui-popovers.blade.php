			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<div class="btn-list popover-list">
								<button class="btn btn-primary" type="button" data-bs-toggle="popover" title="" data-bs-content="And here's some amazing content. It's very engaging. Right?" data-bs-original-title="Popover title">Click to toggle popover</button>
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<span class="d-inline-block" tabindex="0" data-bs-toggle="popover" title="Disabled popover" data-bs-content="Disabled popover content">
