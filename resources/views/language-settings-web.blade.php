                    ...
                    <div class="card flex-fill mb-0 w-50">
                        <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                            ...
                            <div class="page-btn d-flex align-items-center ms-0">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary ms-3" data-bs-toggle="modal"
                                    data-bs-target="#add-language">Add Translation</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-top p-0">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="back-btn">
                                        <a href="{{route('language-settings')}}" class="btn btn-secondary me-3"><i
                                                data-feather="arrow-left" class="filter-icon me-2"></i>Back to
                                            Translations </a>
                                    </div>
                                    <div class="page-btn">
                                        <a href="javascript:void(0);"
                                            class="d-flex align-items-center selected-language"><img
                                                src="{{URL::asset('build/img/icons/flag-03.svg')}}" class="me-2"
                                                alt="Img">Arabic</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="progress progress-xs" style="width: 120px;">
                                                        <div class="progress-bar bg-pink rounded" role="progressbar"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="progress progress-xs" style="width: 120px;">
                                                        <div class="progress-bar bg-warning rounded" role="progressbar"
                                                            style="width: 40%;" aria-valuenow="70" aria-valuemin="0"
                                                            aria-valuemax="100"></div>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="progress progress-xs" style="width: 120px;">
                                                        <div class="progress-bar bg-orange rounded" role="progressbar"
