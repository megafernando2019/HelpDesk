                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Used to send emails safely and easily via PHP code from
                                                    a web server.</p>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="flex-column align-items-start">
                                                ...
                                                <p class="mb-3">SMTP is used to send, relay or forward messages from a
                                                    mail client.</p>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="flex-column align-items-start">
                                                ...
                                                <p class="mb-3">Cloud-based email marketing tool that assists marketers
                                                    and developers .</p>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <a href="#" class="btn btn-outline-secondary" data-bs-toggle="modal"
                                                        data-bs-target="#send-grid">
