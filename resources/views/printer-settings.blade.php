                ...
                <div class="settings-wrapper d-flex">
                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('printer-settings')}}" class="active">Printer
                                                        </a></li>
                    ...
                    <div class="card flex-fill mb-0 w-50">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>Printer</h4>
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-printer"><i
                                    class="ti ti-circle-plus me-1"></i>Add New Printer</a>
                        </div>
                        <div class="card-body">
