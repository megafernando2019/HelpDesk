            ...
            <div class="col-xl-12">
                <div class="settings-wrapper d-flex">
                    ...
                    <div class="card flex-fill mb-0">
                        ...
                        <div class="card-body">
                            <form action="{{route('localization-settings')}}">
                                    ...
                                    <div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="localization-select ms-sm-auto mb-3">
                                                    <select class="select">
                                                        <option>01 Jan 2026</option>
                                                        <option>Jul 22 2026</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="localization-info">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <div
                                                    class="localization-select ms-sm-auto mb-3 d-flex align-items-center mb-sm-0">
