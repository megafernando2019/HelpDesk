							...
							<div class="border-bottom pb-2 mb-4">
								...
								<div class="border-start border-purple border-3 mb-3">
									<div class="ps-3">
										...
										<p class="fs-12"><i class="ti ti-calendar-check text-info me-2"></i>15 Mar 2026</p>
									</div>
								</div>
								<div class="border-start border-pink border-3 mb-3">
									<div class="ps-3">
										<h6 class="fw-medium mb-1">Design System With Client</h6>
										<p class="fs-12"><i class="ti ti-calendar-check text-info me-2"></i>24 Mar 2026</p>
									</div>
								</div>
								<div class="border-start border-success border-3 mb-3">
									<div class="ps-3">
										<h6 class="fw-medium mb-1">UI/UX Team Call</h6>
										<p class="fs-12"><i class="ti ti-calendar-check text-info me-2"></i>28 Mar 2026</p>
									</div>
								</div>
							</div>
							<!-- /Upcoming Event -->
