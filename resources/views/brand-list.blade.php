							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/beats.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/nike.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/apple.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/amazon.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/woodmart.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/dior.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/lava.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/nilkamal.png')}}" alt="img">
											</a>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);" class="avatar avatar-md bg-light-900 p-1 me-2">
												<img class="object-fit-contain" src="{{URL::asset('./build/img/brand/the-north-force.png')}}" alt="img">
											</a>
