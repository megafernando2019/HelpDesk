            ...
            <div class="col-xl-12">
                <div class="settings-wrapper d-flex">
                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('invoice-templates')}}" class="active">Invoice
                                                            Templates</a></li>
                    ...
                    <div class="card flex-fill mb-0">
                        <form action="{{route('invoice-settings')}}">
                            <div class="card-header">
                                <h4>Invoice Templates</h4>
                            </div>
                            <div class="card-body pb-0">
                                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                                    <ul class="nav nav-pills low-stock-tab d-flex me-2 mb-0" id="pills-tab"
                                        role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-home" type="button" role="tab"
                                                aria-controls="pills-home" aria-selected="true">Invoices</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-profile" type="button" role="tab"
                                                aria-controls="pills-profile" aria-selected="false">Purchases</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-profile-tab2" data-bs-toggle="pill"
                                                data-bs-target="#pills-profile2" type="button" role="tab"
                                                aria-controls="pills-profile2" aria-selected="false">Receipts</button>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-mg-6">
                                                <div class="card bg-light invoice-card">
                                                    <div class="card-body p-2">
                                                        <span class="d-block mb-2"><img
                                                                src="{{URL::asset('build/img/invoice/invoice-01.svg')}}"
                                                                class="w-100" alt="Img"></span>
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <p class="mb-0">General Invoice 1</p>
                                                            <a href="#"
                                                                class="avatar avatar-sm rounded-circle bg-secondary-transparent"><i
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-xl-3 col-lg-4 col-mg-6">
                                                <div class="card bg-light invoice-card">
                                                    <div class="card-body p-2">
                                                        <span class="d-block mb-2"><img
                                                                src="{{URL::asset('build/img/invoice/invoice-02.svg')}}"
                                                                class="w-100" alt="Img"></span>
                                                        <div class="d-flex align-items-center justify-content-between">
