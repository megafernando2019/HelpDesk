    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{url('invoice')}}" class="btn btn-primary"><i data-feather="arrow-left" class="me-2"></i>Back to Invoices</a>
                </div>
            </div>
                    ...
                    <div class="row border-bottom mb-3">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <span class="bg-success text-white fs-10 px-1 rounded"><i class="ti ti-point-filled "></i>Paid</span>
                                <div class="mt-3">
