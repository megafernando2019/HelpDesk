                                    ...
                                    <li class="submenu-open">
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    <li><a href="{{route('system-settings')}}" class="active">System
                                                            Settings</a></li>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card flex-fill">
                                        <div class="card-body">
                                            ...
                                            <p class="fs-14 mb-3">Captcha helps protect you from spam and password
                                                decryption</p>
                                            <div>
                                                <a href="#" class="btn btn-outline-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#google-captcha"><i
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card flex-fill">
                                        <div class="card-body">
                                            ...
                                            <p class="fs-14 mb-3">Provides statistics and basic analytical tools for SEO
                                                and marketing purposes.</p>
                                            <div>
                                                <a href="#" class="btn btn-outline-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#google-analytics"><i
                                                        class="ti ti-tool me-1"></i>View Integration</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card flex-fill">
                                        <div class="card-body">
                                            ...
                                            <p class="fs-14 mb-3">Provides a way for publishers to earn money from their
                                                online content.</p>
                                            <div>
                                                <a href="#" class="btn btn-outline-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#google-adsense"><i
                                                        class="ti ti-tool me-1"></i>View Integration</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6 d-flex">
                                    <div class="card flex-fill">
                                        <div class="card-body">
                                            ...
                                            <p class="fs-14 mb-3">Provides detailed information about geographical
                                                regions and sites worldwide.</p>
                                            <div>
                                                <a href="#" class="btn btn-outline-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#configure-google-map"><i
                                                        class="ti ti-tool me-1"></i>View Integration</a>
                                            </div>
                                        </div>
                                    </div>
