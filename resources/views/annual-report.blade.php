                            ...
                            <div class="col-md-3">
                                <div>
                                    ...
                                    <div class="input-icon position-relative">
                                        ...
                                        <input type="text" class="form-control yearpicker" value="2026">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tfoot>
                                <tr>
                                    <td class="bg-light text-dark fw-bold p-3 fs-16">Total</td>
                                    <td class="bg-light text-dark fw-bold p-3 fs-16">$8,000</td>
                                    <td class="bg-light text-dark fw-bold p-3 fs-16">$8,000</td>
                                    <td class="bg-light text-dark fw-bold p-3 fs-16">$8,000</td>
                                    <td class="bg-light text-dark fw-bold p-3 fs-16">$8,000</td>
                                </tr>
