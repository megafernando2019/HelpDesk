                ...
                <div class="settings-wrapper d-flex">
                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('tax-rates')}}" class="active">Tax Rates</a>
                                                    </li>
                    ...
                    <div class="card flex-fill mb-0 w-50">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>Tax Rates</h4>
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-tax"><i
                                    class="ti ti-circle-plus me-1"></i>Add New Tax Rate</a>
                        </div>
                        <div class="card-body">
