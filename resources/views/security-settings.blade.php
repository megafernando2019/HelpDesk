                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div
                                            class="status-toggle modal-status d-flex justify-content-between align-items-center ms-3">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary mt-0"
                                            data-bs-toggle="modal" data-bs-target="#phone-verification">Change</a>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary mt-0"
                                            data-bs-toggle="modal" data-bs-target="#email-verification">Change</a>
                                        <a href="javascript:void(0);" class="btn btn-secondary ms-3">Remove</a>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary mt-0" data-bs-toggle="modal"
                                        data-bs-target="#device-management">Manage</a>
                                </div>
                                <div
                                    class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 border-bottom mb-3 pb-3">
                                    <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary mt-0" data-bs-toggle="modal"
                                        data-bs-target="#account-activity">View</a>
                                </div>
                                <div
                                    class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 border-bottom mb-3 pb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="fs-16">This will shutdown your account. Your account will be
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#delete-account">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
