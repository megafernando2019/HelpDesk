				...
				<div class="col-xxl-6 col-xl-6 col-lg-12">
					...
					<div class="row row-cols-12">
						<div class="col">
							<div class="card">
								<div class="card-body">
									<img src="{{URL::asset('build/img/img-04.jpg')}}" class="card-img mb-3" alt="...">
						...
						<div class="col">
							<div class="card">
								<div class="card-body">
									<img src="{{URL::asset('build/img/img-05.jpg')}}" class="card-img mb-3" alt="...">
						...
						<div class="col">
							<div class="card">
								<div class="card-body">
									<img src="{{URL::asset('build/img/img-02.jpg')}}" class="card-img mb-3" alt="...">
					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center w-100">
								<img src="{{URL::asset('build/img/avatar/avatar-1.jpg')}}" alt="img" class="avatar avatar-rounded me-2">
								<div>
			...
			<div class="row">
				<div class="col-xl-4">
					<div class="card">
						<div class="row g-0">
							<div class="col-md-4">
								<img src="{{URL::asset('build/img/img-05.jpg')}}" class="img-fluid rounded-start object-fit-cover h-100 w-100" alt="...">
							</div>
							<div class="col-md-8">
								<div class="card-header">
				...
				<div class="col-xl-4">
					<div class="card">
						<div class="row g-0">
							...
							<div class="col-md-4">
								<img src="{{URL::asset('build/img/img-01.jpg')}}" class="img-fluid rounded-end object-fit-cover h-100 w-100" alt="...">
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-4">
					<div class="card">
						<div class="row g-0">
							...
							<div class="col-md-4">
								<img src="{{URL::asset('build/img/img-02.jpg')}}" class="img-fluid rounded-end object-fit-cover h-100 w-100" alt="...">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-xxl-7 col-xl-12">
							<div class="card">
								...
								<div class="row g-0">
									...
									<div class="col-md-4">
										<img src="{{URL::asset('build/img/img-5.jpg')}}" class="img-fluid rounded-end object-fit-cover h-100" alt="...">
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="row row-cols-1 row-cols-md-4 g-4">
						...
						<div class="col">
							<div class="card">
								<img src="{{URL::asset('build/img/img-04.jpg')}}" class="card-img-top" alt="...">
								<div class="card-body">
