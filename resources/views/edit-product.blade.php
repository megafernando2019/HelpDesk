		...
		<div class="content">
			<div class="page-header">
				...
				<div class="page-btn mt-0">
					<a href="{{url('product-list')}}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Product</a>
				</div>
			</div>
			
			<form action="{{url('edit-product')}}" class="add-product-form">
									...
									<div class="row">
										<div class="col-sm-6 col-12">
											<div class="mb-3">
												...
												<input type="text" class="form-control" value="Lenovo 3rd Generation">
											</div>
										</div>
										<div class="col-sm-6 col-12">
											<div class="mb-3">
									...
									<div class="row">
										<div class="col-sm-6 col-12">
											<div class="mb-3 list position-relative">
												...
												<input type="text" class="form-control list" value="LNV-IP3-8GB-256SSD-BLK">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-sm-6 col-12">
											<div class="mb-3 list position-relative">
												...
												<input type="text" class="form-control list" value="PT001">
												<button type="submit" class="btn btn-primaryadd">
													Generate
												</button>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-4 col-sm-6 col-12">
													<div class="mb-3">
														...
														<input type="text" class="form-control" value="650">
													</div>
												</div>
												<div class="col-lg-4 col-sm-6 col-12">
													<div class="mb-3">
												...
												<div class="mb-3">
													...
													<div class="row">
														<div class="col-lg-10 col-sm-10 col-10">
															<select class="form-control variant-select select-option select" id="colorSelect">
											...
											<div class="col-sm-6 col-12">
												<div class="mb-3">
													...
													<div class="input-groupicon calender-input">
														...
														<input type="text" class="datetimepicker form-control" value="20 Dec 2024">
													</div>
												</div>
											</div>
											<div class="col-sm-6 col-12">
												<div class="mb-3">
													...
													<div class="input-groupicon calender-input">
														<i data-feather="calendar" class="info-img"></i>
														<input type="text" class="datetimepicker form-control" value="18 Dec 2034">
													</div>
												</div>
											</div>
										</div>
