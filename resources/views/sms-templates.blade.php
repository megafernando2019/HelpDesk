                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                                                            class="active subdrop">SMS<span
                                                                class="menu-arrow inside-submenu"></span></a>
                                                        <ul>
                                                            <li><a href="{{route('sms-settings')}}">SMS Settings</a>
                                                            </li>
                                                            <li><a href="{{route('sms-templates')}}" class="active">SMS
                                                                    Templates</a></li>
                                                        </ul>
                                                    </li>
                            ...
                            <div class="accordion-card-one accordion" id="accordionExample">
                                <div class="accordion-item pb-3">
                                    <div class="accordion-header" id="headingOne">
                                        <div class="accordion-button p-3 pb-0" data-bs-toggle="collapse"
                                            data-bs-target="#collapseOne" aria-controls="collapseOne">
                                            <div
                                                class="addproduct-icon d-flex align-items-center justify-content-between w-100">
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        class="status-toggle modal-status d-flex justify-content-between align-items-center me-2">
...
Best, The <span class="text-orange">{Company Name}</span> Team
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap row-gap-3">
                                                        ...
                                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                                                            data-bs-target="#email-detail">Preview Template</a>
                                                    </div>
                                                </div>
                                                <div class="col-xl-5">
                                                    <div class="card mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="fs-12 text-orange mb-1">{Password Reset Link}
                                                                </p>
                                                ...
                                                <div class="col-xl-7">
                                                    <div class="card mb-3">
                                                        <div class="card-body">
                                                            ...
                                                            Hi <span class="text-orange">{Customer Name}</span>,<br>
                                                            Welcome to <span class="text-orange">{Company Name}</span>!

                                                            We're thrilled to have you as part of our community and are
                                                            eager to support you in optimizing your operations. Thank
                                                            you for choosing us – we appreciate your trust and
                                                            confidence.

                                                            At <span class="text-orange">{Company Name}</span>, our
                                                            mission is to make your experience seamless and efficient.
                                                            From managing day-to-day tasks to improving workflows, we're
                                                            here to help you get the most out of our solutions.

                                                            If you have any questions or need assistance, our dedicated
                                                            support team is always ready to assist you. Feel free to
                                                            reach out anytime – we're committed to ensuring your
                                                            success.

                                                            Thank you again for trusting <span
                                                                class="text-orange">{Company Name}</span>. We're excited
                                                            to be part of your journey and look forward to supporting
                                                            you every step of the way.

                                                            Best, The <span class="text-orange">{Company Name}</span>
                                                            Team
                                                            </textarea>
                                                        </div>
                                                    </div>
