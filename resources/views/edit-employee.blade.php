								...
								<div class="row">
									<div class="col-lg-4 col-md-6">
										<div class="input-blocks mb-md-0 mb-sm-3">
											...
											<div class="pass-group">
												<input type="password" class="pass-input form-control" value="12345678">
									...
									<div class="col-lg-4 col-md-6">
										<div class="input-blocks mb-0">
											...
											<div class="pass-group">
												<input type="password" class="pass-inputa form-control" value="12345678">
